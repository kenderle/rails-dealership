class Api::V1::EmployeesController < ApplicationController
    ...
    def create
        @user=UsersService.register(params[:position], params[:first_name], params[:last_name], params[:username], params[:password], params[:password_confirmation])
    ...
    def user_params
        params.require(:user).permit(:first_name, :last_name, :username, :position, :password, :password_confirmation)
    end
end
